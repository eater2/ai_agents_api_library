...
| [Azure AI Document Intelligence](https://azure.microsoft.com/products/ai-services/ai-document-intelligence) | Analyze forms, invoices, receipts, and scanned documents to extract structured JSON via REST API. | cloud IAM | [◐](https://playbooks.com/mcp/cognitive-stack-azure-form-recognizer) | 🆓 free tier: F0 pricing tier, 500 pages/month, rate-limited | [docs](https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/) |
...
| [Docker Hub API](https://docs.docker.com/docker-hub/api/latest/) | An agent can search, push, pull, tag, and manage container images and repositories on Docker Hub. | API key | [✅](https://github.com/docker/hub-mcp) | 🆓 free personal accounts with rate-limited image pulls; paid Pro/Team/Business tiers raise pull limits | [docs](https://hub.docker.com/reference/api/hub/latest/) |
...
| [Render API](https://render.com/docs/api) | An agent can create and manage Render services, trigger deployments, and configure databases and env vars. | API key | [✅](https://mcp.render.com) | 🆓 free static sites; free web services that spin down after inactivity | [docs](https://api-docs.render.com/reference/introduction) |
